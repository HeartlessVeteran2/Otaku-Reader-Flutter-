...
class HttpBridge {
  ...
  void registerBridgedClasses(D4rt interpreter) {
    ...
    interpreter.registerBridgedClass(clientBridgedClass, kBridgeLibraryUri);
    interpreter.registerBridgedClass(responseBridgedClass, kBridgeLibraryUri);
    interpreter.registerBridgedClass(
      streamedResponseBridgedClass,
      kBridgeLibraryUri,
    );
    interpreter.registerBridgedClass(byteStreamBridgedClass, kBridgeLibraryUri);
  }
}
