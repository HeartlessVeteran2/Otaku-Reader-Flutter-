...
class FilterBridge {
  ...
  void registerBridgedClasses(D4rt interpreter) {
    interpreter.registerBridgedClass(filterBridgedClass, kBridgeLibraryUri);
    ...
    interpreter.registerBridgedClass(textFilterBridgedClass, kBridgeLibraryUri);
    interpreter.registerBridgedClass(sortFilterBridgedClass, kBridgeLibraryUri);
    interpreter.registerBridgedClass(
    ...
    interpreter.registerBridgedClass(sortStateBridgedClass, kBridgeLibraryUri);
    interpreter.registerBridgedClass(
