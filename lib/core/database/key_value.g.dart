...
extension KeyValueQueryWhere on QueryBuilder<KeyValue, KeyValue, QWhereClause> {
  ...
  QueryBuilder<KeyValue, KeyValue, QAfterWhereClause> keyIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        IndexWhereClause.equalTo(indexName: r'key', value: [null]),
      );
    });
  }

  QueryBuilder<KeyValue, KeyValue, QAfterWhereClause> keyIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
...
extension KeyValueQueryFilter
  ...
  QueryBuilder<KeyValue, KeyValue, QAfterFilterCondition> keyIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<KeyValue, KeyValue, QAfterFilterCondition> keyIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
