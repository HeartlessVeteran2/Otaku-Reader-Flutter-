...
**Categories** — [x] create/rename/delete/reorder · [x] filter the grid · [x] assign from the details screen · [ ] **hidden** (biometric-gated) · [ ] NSFW · [ ] locked · [ ] per-category update frequency · [ ] skip-updates toggle · [ ] **dynamic/smart categories** (11 rule types)
